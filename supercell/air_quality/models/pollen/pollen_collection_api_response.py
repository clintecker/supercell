...
from supercell.air_quality.models.pollen.pollen_index_forecast import (
    PollenIndexForecast,
)
from supercell.air_quality.models.pollen.pollen_response_metadata import (
    PollenAPIResponseMetadata,
)


class PollenCollectionAPIResponse(AirQualityModel):
    """
