...
from supercell.breezometer.air_quality.models.air_quality_api_response_data import (
...
def test_model():
    assert (
        "AirQualityAPIResponse [2020-01-01T01:01:01+00:00]: metadata=AirQualityAPIResponseMetadata "
        ...
        AirQualityAPIResponse(
            ...
            metadata=AirQualityAPIResponseMetadata(
...
def test_initialize_from_dictionary():
    assert (
        "AirQualityAPIResponse [2020-08-27T17:53:28+00:00]: metadata=AirQualityAPIResponseMetadata "
