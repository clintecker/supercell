...
def test_model():
    ...
    assert (
        "FiresAPIResponseData [2020-01-01 01:01:01.000001+00:00] data_available=True, fire_count=2"
        == str(obj)
    )
...
def test_initialize_from_dictionary():
    obj = str(
        FiresAPIResponseData.initialize_from_dictionary(
            response_dictionary={
                "data_available": True,
    ...
    assert (
        "FiresAPIResponseData [2020-09-13 19:00:00+00:00] data_available=True, fire_count=17"
        == str(obj)
    )
