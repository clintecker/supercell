...
class SupercellGoesTestSuite(unittest.TestCase):
    def test_get_image_data(self):
        d = supercell.goes.get_image_data(
    ...
    def test_get_image_data_bad_url(self):
        d = supercell.goes.get_image_data(
            "https:/doesnt.matter.com/something_different.jpg")
        self.assertEqual(
            {},
            d
        )
    ...
    def test_does_exist(self):
        responses.add(
            ...
            url="https://example.com/bloop.jpg",
            status=200
        )
        responses.add(
            method=responses.HEAD,
        ...
        self.assertTrue(supercell.goes.does_exist("https://example.com/bloop.jpg"))
        self.assertFalse(supercell.goes.does_exist("https://example.com/nope.png"))
    ...
    def test_image_url_from_data(self):
        ...
        self.assertEqual(
            ...
            ".jpg",
            supercell.goes.image_url_from_data(d)
        )
    ...
    def test_in_cache(self):
        with tempfile.NamedTemporaryFile(mode="r") as f:
            ...
            key = f_parts[-1]
            full_key = supercell.goes.in_cache(
                key=key,
                directory=directory
            )
        self.assertEqual(
    ...
    def test_store_in_cache(self):
        with tempfile.TemporaryDirectory() as d:
            supercell.goes.store_in_cache(
                key="bloop.txt",
                directory=d,
                data=b"1234567890"
            )
            supercell.goes.in_cache(key="bloop.txt", directory=d)
...
<a href="thumbnail.jpg">thumbnail.jpg</a>                                      01-Jun-2020 20:03              103347
        ...
        urls = supercell.goes.full_day_images(
            sat="G16",
            sector="nr",
            band="GEOCOLOR",
            size=1200,
        ...
        self.assertEqual(
            [],
            supercell.goes.full_day_images(
                sat="G16",
                sector="xx",
                band="GEOCOLOR",
                size=1200,
        ...
        self.maxDiff = 1024
        u = supercell.goes.full_day_images(
            sat="G16",
            sector="yy",
            band="GEOCOLOR",
            size=1200,
