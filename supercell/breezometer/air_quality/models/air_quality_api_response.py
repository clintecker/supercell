...
class AirQualityAPIResponse(BreezoMeterModel):
    ...
    metadata: Optional[AirQualityAPIResponseMetadata]
    ...
    def initialize_from_dictionary(cls, response_dictionary: Dict[str, Any]):
        ...
        if metadata_data:
            metadata = AirQualityAPIResponseMetadata.initialize_from_dictionary(
